      ...
      <div className="w-[85%] h-full flex ">
        ...
        <div className=" w-[40%] h-[90%]  flex py-9 justify-center relative shadow-2xl rounded-xl bg-white">
          ...
          <div className="flex absolute space-x-4 bottom-2 w-[90%] items-center justify-center py-4 px-10  rounded-2xl bg-white">
            <div
              className="shadow-xl  rounded-full p-3 group hover:cursor-pointer hover:text-blue-700 text-gray-900"
              onClick={toggleVideo}
            >
            ...
            <div className="shadow-xl rounded-full p-3 group hover:cursor-pointer hover:text-blue-700 text-gray-900">
        ...
        <Medications
          ...
          setopenMedications={setopenMedications}
          closeMeds={closeMeds}
          openMeds={openMeds}
        />
        <Prescriptions
